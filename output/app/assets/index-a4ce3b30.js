...
function createRouterMatcher(routes2, globalOptions) {
  ...
  function addRoute(record, parent, originalRecord) {
    ...
    for (const normalizedRecord of normalizedRecords) {
      ...
      if (mainNormalizedRecord.children) {
        ...
        for (let i = 0; i < children2.length; i++) {
          addRoute(children2[i], matcher2, originalRecord && originalRecord.children[i]);
        }
      }
  ...
  function insertMatcher(matcher2) {
    let i = 0;
    while (i < matchers.length && comparePathParserScore(matcher2, matchers[i]) >= 0 && // Adding children with empty path should still appear before the parent
    // https://github.com/vuejs/router/issues/1124
    (matcher2.record.path !== matchers[i].record.path || !isRecordChildOf(matcher2, matchers[i])))
      i++;
...
const RouterLinkImpl = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      const children2 = slots.default && slots.default(link2);
...
const _withScopeId = (n) => (pushScopeId("data-v-5b7c4b71"), n = n(), popScopeId(), n);
const _hoisted_1$6 = { class: "nav" };
const _hoisted_2$4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("a", { href: "/doc/" }, "Documentation", -1));
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        ...
        createVNode(unref(RouterLink), { to: "/sites" }, {
          default: withCtx(() => [
            createTextVNode("Project Sites")
          ]),
          _: 1
        }),
        createVNode(unref(RouterLink), { to: "/define" }, {
          default: withCtx(() => [
            createTextVNode("Editor")
          ]),
          _: 1
        }),
        createVNode(unref(RouterLink), { to: "/workers" }, {
          default: withCtx(() => [
            createTextVNode("Workers")
          ]),
          _: 1
        }),
        createVNode(unref(RouterLink), { to: "/queue" }, {
          default: withCtx(() => [
            createTextVNode("Processing Queue")
          ]),
          _: 1
        }),
        _hoisted_2$4
...
const NavBar_vue_vue_type_style_index_0_scoped_5b7c4b71_lang = "";
...
const NavBar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-5b7c4b71"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  __name: "ToDoList",
  setup(__props) {
    const todos = ref(["host on render", "add a todo list component", "describe how to login", "get octave client to connect", "create a worker view", "get matlab client to connect", "get HPC matlab clients to connect", "get manager set up", "haver manager push jobs to api"]);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("ul", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(todos.value, (todo, index) => {
            return openBlock(), createElementBlock("li", { key: index }, toDisplayString(todo), 1);
          }), 128))
        ])
      ]);
    };
...
const ToDoList_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$5 = { id: "app" };
const _hoisted_2$3 = { class: "banner" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        createVNode(_component_RouterLink, { to: "/todo/user1" }, {
          default: withCtx(() => [
            createTextVNode("Todo User 1")
          ]),
          _: 1
        })
      ]);
...
Transform.prototype;
class MyNode {
  constructor(name, parent = null, children2 = []) {
...
const _sfc_main$4 = {
  ...
  methods: {
    drawChart() {
      ...
      (_a = data.findChild("B")) == null ? void 0 : _a.addChild("BB_0");
      (_b = data.findChild("B")) == null ? void 0 : _b.addChild("BB_1");
      (_c = data.findChild("C")) == null ? void 0 : _c.addChild("CC");
      (_e = (_d = data.findChild("B")) == null ? void 0 : _d.findChild("BB_1")) == null ? void 0 : _e.addChild("BBB");
      console.log(data);
      const width = 1024;
      const fontSize = 22;
      ...
      const dy = width / (root2.height + 1);
      const tree$1 = tree().nodeSize([dx, dy]);
      root2.sort((a, b) => ascending$1(a.data.name, b.data.name));
      tree$1(root2);
      let x0 = Infinity;
      let x1 = -x0;
      root2.each((d) => {
      ...
      const svg = create$1("svg").attr("width", width).attr("height", height).attr("viewBox", [-dy / 3, x0 - dx, width, height]).attr("style", "max-width: 100%; height: auto; font: " + fontSize + "px sans-serif;");
      svg.append("g").attr("fill", "none").attr("stroke", lineColor).attr("stroke-opacity", 0.5).attr("stroke-width", 1.5).selectAll().data(root2.links()).join("path").attr(
        "d",
        linkHorizontal().x((d) => d.y).y((d) => d.x)
      );
      const node = svg.append("g").attr("stroke-linejoin", "round").attr("stroke-width", 3).selectAll().data(root2.descendants()).join("g").attr("transform", (d) => `translate(${d.y},${d.x})`);
      node.append("circle").attr("fill", (d) => d.children ? dotColorBranch : dotColorLeaf).attr("r", dotSize);
      node.append("text").attr("fill", fontColor).attr("dy", "0.31em").attr("x", (d) => d.children ? -6 : 6).attr("text-anchor", (d) => d.children ? "end" : "start").text((d) => d.data.name).clone(true).lower().attr("stroke", outlineColor);
...
const _hoisted_1$4 = { ref: "chart" };
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    createBaseVNode("div", null, "User " + toDisplayString(_ctx.$route.params.id), 1),
    createBaseVNode("div", _hoisted_1$4, null, 512)
  ], 64);
}
const Todo = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1]]);
const _sfc_main$3 = {};
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("h1", null, "Not found", -1);
const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("p", null, "This is the not found page", -1);
const _hoisted_3$2 = [
  _hoisted_1$3,
  _hoisted_2$2
];
...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render]]);
const _hoisted_1$2 = { style: { "height": "100vh", "width": "100vw" } };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loadHtml = () => {
      ...
      fetch(htmlPath).then((response) => response.text()).then((data) => {
        dynaHtml.value = data;
      }).catch((error) => {
...
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("button", { type: "submit" }, "Login", -1);
const _hoisted_3 = { key: 0 };
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("h2", null, "Workers:", -1);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    watch(token, async (newToken) => {
      ...
      if (newToken) {
        ...
        if (response.ok) {
          ...
          let workers2 = JSON.parse(decodedString);
          console.log(workers2);
          const workerList = document.createElement("div");
          workerList.innerHTML = workers2.workers.map((worker) => `<div>${worker.worker_id}</div>`).join("");
          document.body.appendChild(workerList);
        }
      }
    });
    ...
    if (localToken) {
      ...
      const response = ([__temp, __restore] = withAsyncContext(() => fetch("api/workers", {
        method: "GET",
        headers: {
          Authorization: `${token.value}`
        }
      })), __temp = await __temp, __restore(), __temp);
      [__temp, __restore] = withAsyncContext(() => response.text()), await __temp, __restore();
      if (response.status == 200) {
        [__temp, __restore] = withAsyncContext(() => response.text()), await __temp, __restore();
        const workers2 = ([__temp, __restore] = withAsyncContext(() => response.json()), __temp = await __temp, __restore(), __temp);
        const workerList = document.createElement("div");
        workerList.innerHTML = workers2.map((worker) => `<div>${worker.worker_id}</div>`).join("");
        document.body.appendChild(workerList);
      } else {
        token.value = "";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        ...
        workers.value.workers.length ? (openBlock(), createElementBlock("div", _hoisted_3, [
          _hoisted_4,
          (openBlock(true), createElementBlock(Fragment, null, renderList(workers.value.workers, (worker) => {
            return openBlock(), createElementBlock("div", {
              key: worker.worker_id
            }, toDisplayString(worker.worker_id), 1);
          }), 128))
...
app.use(router);
app.mount("#app");
//# sourceMappingURL=index-a4ce3b30.js.map
