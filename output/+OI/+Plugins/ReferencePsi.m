classdef ReferencePsi < OI.Plugins.PluginBase
    properties
        inputs = { ...
            ...
            OI.Data.Catalogue(), ...
            OI.Data.OrbitFileIndex(), ... % OI.Data.OrbitSummary(), ...
            ...
            OI.Data.PSIUploadSummary() ...
            }
            % OI.Data.PscSampleSummary(), ... % queued by Aps Plugin
        ...
        function this = run( this, engine, ~ )
            for ii = 1:numel(this.inputs)
                ...
                if isempty(data)
                    ...
                    engine.ui.log('info', 'Starting Plugin %s\n', this.inputs{ii}.generator);
