classdef TransientScatterers < OI.Plugins.PluginBase
    properties
        inputs = { ...
            OI.Data.Sentinel1DownloadSummary(), ...
                OI.Data.Catalogue(), ...
                OI.Data.OrbitFileIndex(), ...
                ...
                OI.Data.SHPMasksSummary(), ...
                OI.Data.TransientBehaviourSamples() ...
                OI.Data.ApsModelSummary(), ...
            };
            % OI.Data.PersistentScatterersInversion(), ...
        ...
        outputs = {OI.Data.TransientScatterers_Summary()}
        id = 'TransientScatterers'
    end
